            ...
            public void onReceive(Context context, Intent intent) {
                ...
                try {
                    ...
                    if (sensorType == 1) {
                        ...
                        if (((tmpX == 1000)&&(tmpY == 1000)&&(tmpZ == 1000))||((tmpX == 2000)&&(tmpY == 2000)&&(tmpZ == 2000))||((tmpX == 3000)&&(tmpY == 3000)&&(tmpZ == 3000))||((tmpX == 5000)&&(tmpY == 5000)&&(tmpZ == 5000))) {

                            falldetectionTxt.setText("No fall Detected.");

                            if ((tmpX == 5000)&&(tmpY == 5000)&&(tmpZ == 5000)) {
                                stateactivity = 0; //Delay Initialization
                            }
                    ...
                    if ((message1 != null ) && (sensorType == 21)) {
                        ...
                        if (tmpHr > 0) {
                            ...
                            //13. Activity Recognition dari data accelerometer yang didapat
                            if (stateactivity == 0) {
                                Log.i("AI Activity conclusion", "Activity Conclusion: Initialization, State: " + stateactivity);
                                //masukin kode ngitung minimum heartrate normality
                            }
                            ...
                            if (tmpHr < 60.0) {
                                ...
                                String telNr = emergencyNumber1Fr;
